...
const AI_PHRASAL_PATTERNS = [
  ...
  /\bserves as a (?:cornerstone|foundation|testament|catalyst|crucial pillar|retrieval backbone|foundational pillar)\b/gi,
  /\bby leveraging (?:advanced|state-of-the-art|deep learning|predictive)?\b/gi,
  /\b(?:foundational pillar|unplanned downtime|optimizing resource allocation)\b/gi,

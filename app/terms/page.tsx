...
export const metadata: Metadata = {
  title: 'Terms of Service | AIDetector.buzz',
  description: 'AIDetector.buzz Terms of Service: Acceptable use guidelines, statistical detection disclaimers, and OpenRouter BYOK billing terms.',
}
      ...
      <main style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 20px 80px' }}>
        ...
        <div style={{ lineHeight: 1.75, fontSize: '1rem', color: '#374151' }}>
          <section style={{ marginBottom: '32px' }}>
            ...
            <p>
              By accessing or using AIDetector.buzz (the &ldquo;Service&rdquo;), including our web application, Chrome Extension, and API endpoints, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you must discontinue use immediately.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            <p style={{ marginBottom: '12px' }}>
              AIDetector.buzz provides statistical and machine-learning assessments of text predictability, including <strong>Perplexity Analysis</strong>, <strong>Multi-Scale Burstiness</strong>, and <strong>LLM Verifier Inferences</strong>:
            </p>
            <ul style={{ paddingLeft: '24px', listStyleType: 'disc', marginBottom: '12px' }}>
              ...
              <li><strong>No Sole-Basis Disciplinary Action:</strong> AIDetector.buzz is designed as an editorial assistant and verification tool. Detection scores should never serve as the sole ground for punitive, disciplinary, academic expulsion, or employment termination actions without independent corroboration.</li>
              <li><strong>Evolving AI Models:</strong> As generative language models continue to evolve, statistical markers change over time. AIDetector.buzz continuously updates detection heuristics but does not guarantee 100% detection of all future unreleased model variants.</li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            <p style={{ marginBottom: '12px' }}>
              AIDetector.buzz provides an open Bring-Your-Own-Key model via OpenRouter OAuth:
            </p>
            <ul style={{ paddingLeft: '24px', listStyleType: 'disc', marginBottom: '12px' }}>
              ...
              <li>AIDetector.buzz charges no additional surcharge, subscription fee, or per-token markup on BYOK inference calls.</li>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            <p style={{ marginBottom: '12px' }}>
              You agree not to use AIDetector.buzz for:
            </p>
            <ul style={{ paddingLeft: '24px', listStyleType: 'disc', marginBottom: '12px' }}>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            <p>
              To the maximum extent permitted by applicable law, AIDetector.buzz and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of, or inability to use, the detection service or reliance on any detection verdicts.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            <div style={{ marginTop: '12px', padding: '16px 20px', borderRadius: '12px', backgroundColor: '#f9fafb', border: '1px solid #e5e7eb' }}>
              <strong>AIDetector.buzz Legal Department</strong><br />
